			        	...
			        	<form method="POST">
							<div class="input-group mb-3">
								...
								<div class="input-group-prepend">
							  	...
							  	<select class="custom-select" id="typeEdit" name="jenis_barang" onchange="functionTypeEdit()">
						  		<?php
						  		require_once("../conn.php");
						  		$sql = $conn->query("SELECT tipebarang FROM tb_tipebarang");
							  	...
							  	<script type="text/javascript">
									function functionTypeEdit()
									{
										...
										$.ajax({
											...
											{
												console.log(data);
												document.getElementById('kodeitem').value = data;
											}
										});
